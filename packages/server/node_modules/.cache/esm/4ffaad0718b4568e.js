let gql,uuid,createRepository,ListSortmentEnum;_18b‍.x([["typeDefs",()=>typeDefs],["resolvers",()=>resolvers]]);_18b‍.w("apollo-server-express",[["gql",["gql"],function(v){gql=v}]]);_18b‍.w("uuid",[["*",null,function(v){uuid=v}]]);_18b‍.w("../../io/Database/createRepository",[["default",["createRepository"],function(v){createRepository=v}]]);_18b‍.w("../List/List",[["ListSortmentEnum",["ListSortmentEnum"],function(v){ListSortmentEnum=v}]]);
...
const clientRepository = createRepository('client');
    ...
    extend type Mutation {
        createClient(input: CreateClientInpu!): Client!
    }
`;
